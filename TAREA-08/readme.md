...
Este proyecto forma parte de la TAREA 08 del módulo **Desarrollo Web en Entorno Servidor (DWES)**.  
...
- **Tiempo actual** (API Open‑Meteo – sin API key)
...
2. Acceder a:http://empresa-dwcs.local
